 ...
 * (c) 2022 Leo Werneck
 */
void NRPyEOS_P_and_T_from_rho_Ye_S( const eos_parameters *restrict eos,
                                    const double rho,
                                    const double Y_e,
                                    const double S,
                                    double *restrict P,
  ...
  NRPyEOS_from_rho_Ye_aux_find_T_and_interpolate_n_quantities( eos, 1, root_finding_precision,
                                                               rho, Y_e, S, NRPyEOS_entropy_key, keys,
                                                               outvars, T, &report );
