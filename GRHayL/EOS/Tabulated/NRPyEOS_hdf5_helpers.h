 ...
 * @params data Pointer to the pointer that will hold the data.
 *
 ...
 * @retval ghl_error_hdf5_dataset_invalid_ndims HDF5 dataset has wrong number of dimensions.
 * @retval ghl_error_hdf5_dataset_size_mismatch HDF5 dataset size does not match expected size.
 * @retval ghl_error_out_of_memory Could not allocate memory to store the dataset data.
 */
