...
/// @details https://github.com/GRHayL/GRHayL/wiki/ghl_compute_ADM_auxiliaries
void ghl_compute_ADM_auxiliaries(
  ...
  const double shift2 = betaD[0] * ADM_metric->betaU[0] + betaD[1] * ADM_metric->betaU[1]
  ...
  metric_aux->g4UU[1][2] = metric_aux->g4UU[2][1]
      = ADM_metric->gammaUU[0][1] - ADM_metric->betaU[0] * shift_over_lapse2[1];
  metric_aux->g4UU[1][3] = metric_aux->g4UU[3][1]
      = ADM_metric->gammaUU[0][2] - ADM_metric->betaU[0] * shift_over_lapse2[2];
  metric_aux->g4UU[2][2] = ADM_metric->gammaUU[1][1] - ADM_metric->betaU[1] * shift_over_lapse2[1];
  metric_aux->g4UU[2][3] = metric_aux->g4UU[3][2]
      = ADM_metric->gammaUU[1][2] - ADM_metric->betaU[1] * shift_over_lapse2[2];
