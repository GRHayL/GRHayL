...
/*
 * Function : Tabulated_Palenzuela1D_entropy
 * Author   : Leo Werneck
 *
 * This is a wrapper function around the Tabulated_Palenzuela1D that performs
 * a primitive recovery using the Palenzuela et al. scheme using the specific
 * entropy to recover the temperature. See file Tabulated_Palenzuela1D.c for
 * further details.
 */
int Tabulated_Palenzuela1D_entropy(
  ...
  return Tabulated_Palenzuela1D( compute_rho_P_eps_T_W_entropy,
                                 grhayl_params,
                                 eos,
                                 ADM_metric,
                                 cons_undens,
