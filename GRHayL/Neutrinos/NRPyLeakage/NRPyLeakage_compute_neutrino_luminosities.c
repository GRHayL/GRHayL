...
ghl_error_codes_t NRPyLeakage_compute_neutrino_luminosities(
  ...
  double tmp_2_fd, tmp_3_fd;
  NRPYLEAKAGE_FD_OR_RETURN(tmp_2_fd, 4, tmp_1);
  NRPYLEAKAGE_FD_OR_RETURN(tmp_3_fd, 5, tmp_1);
  ...
  double tmp_53_fd;
  NRPYLEAKAGE_FD_OR_RETURN(tmp_53_fd, 5, -tmp_1);
  const double tmp_53 = tmp_53_fd/tmp_30;
  ...
  double tmp_nue_fd4_tmp6, tmp_anue_fd4_tmp14;
  NRPYLEAKAGE_FD_OR_RETURN(tmp_nue_fd4_tmp6, 4, tmp_6);
  NRPYLEAKAGE_FD_OR_RETURN(tmp_anue_fd4_tmp14, 4, tmp_14);
  lum->nue = tmp_39*tmp_52/(((tau->nue[1])*(tau->nue[1]))*tmp_39*tmp_50/((EnsureFinite(tmp_43*tmp_45) + EnsureFinite(tmp_43*tmp_47) + EnsureFinite(Y_np*tmp_43*tmp_48/(exp(tmp_1 - tmp_40/tmp_nue_fd4_tmp6) + 1)))*fmax(tmp_41*tmp_49, 1.0000000000000001e-15)) + 1);
  lum->anue = tmp_52*tmp_54/(((tau->anue[1])*(tau->anue[1]))*tmp_50*tmp_54/((EnsureFinite(tmp_42*tmp_45*tmp_57) + EnsureFinite(tmp_42*tmp_47*tmp_57) + EnsureFinite(Y_pn*tmp_42*tmp_48*tmp_57/(exp(-tmp_1 - tmp_55/tmp_anue_fd4_tmp14) + 1)))*fmax(tmp_49*tmp_56, 1.0000000000000001e-15)) + 1);
