...
void NRPyLeakage_compute_neutrino_luminosities(
  ...
  const double tmp_2 = NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_1);
  const double tmp_3 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_1)/tmp_2;
  ...
  const double tmp_28 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_1);
  const double tmp_29 = (1.0/(tmp_28));
  const double tmp_30 = NRPyLeakage_Fermi_Dirac_integrals_k4(-tmp_1);
  const double tmp_31 = NRPyLeakage_Fermi_Dirac_integrals_k3(-tmp_1);
  ...
  const double tmp_40 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_6);
  const double tmp_41 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_6);
  ...
  const double tmp_53 = NRPyLeakage_Fermi_Dirac_integrals_k5(-tmp_1)/tmp_30;
  ...
  const double tmp_55 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_14);
  const double tmp_56 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_14);
  const double tmp_57 = tmp_55/tmp_56;
  const double tmp_60 = NRPyLeakage_Fermi_Dirac_integrals_k3(0);
  const double tmp_61 = NRPyLeakage_Fermi_Dirac_integrals_k5(0)/tmp_60;
  lum->nue = tmp_39*tmp_52/(((tau->nue[1])*(tau->nue[1]))*tmp_39*tmp_50/((EnsureFinite(tmp_43*tmp_45) + EnsureFinite(tmp_43*tmp_47) + EnsureFinite(Y_np*tmp_43*tmp_48/(exp(tmp_1 - tmp_40/NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_6)) + 1)))*MAX(tmp_41*tmp_49, 1.0000000000000001e-15)) + 1);
  lum->anue = tmp_52*tmp_54/(((tau->anue[1])*(tau->anue[1]))*tmp_50*tmp_54/((EnsureFinite(tmp_42*tmp_45*tmp_57) + EnsureFinite(tmp_42*tmp_47*tmp_57) + EnsureFinite(Y_pn*tmp_42*tmp_48*tmp_57/(exp(-tmp_1 - tmp_55/NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_14)) + 1)))*MAX(tmp_49*tmp_56, 1.0000000000000001e-15)) + 1);
