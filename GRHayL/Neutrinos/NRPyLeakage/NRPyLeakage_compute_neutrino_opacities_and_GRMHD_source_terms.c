...
void NRPyLeakage_compute_neutrino_opacities_and_GRMHD_source_terms(
  ...
  const double tmp_16 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_1);
  const double tmp_17 = (1.0/(tmp_16));
  const double tmp_18 = NRPyLeakage_Fermi_Dirac_integrals_k4(-tmp_1);
  const double tmp_19 = NRPyLeakage_Fermi_Dirac_integrals_k3(-tmp_1);
  ...
  const double tmp_43 = NRPyLeakage_Fermi_Dirac_integrals_k2(tmp_6);
  const double tmp_44 = NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_6);
  ...
  const double tmp_51 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_6);
  ...
  const double tmp_57 = NRPyLeakage_Fermi_Dirac_integrals_k5(-tmp_1)/tmp_18;
  const double tmp_58 = NRPyLeakage_enable_beta_anue*EnsureFinite(Y_np*tmp_10*tmp_18/(exp(tmp_15 - tmp_57) + 1));
  const double tmp_60 = NRPyLeakage_Fermi_Dirac_integrals_k2(tmp_15);
  const double tmp_61 = NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_15);
  const double tmp_62 = tmp_42*tmp_61/tmp_60;
  const double tmp_63 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_15);
  ...
  const double tmp_70 = NRPyLeakage_Fermi_Dirac_integrals_k3(0);
  const double tmp_71 = NRPyLeakage_Fermi_Dirac_integrals_k5(0)/tmp_70;
  ...
  const double tmp_78 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_6);
  ...
  const double tmp_83 = NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_15);
  ...
  const double tmp_87 = NRPyLeakage_Fermi_Dirac_integrals_k4(0)/NRPyLeakage_Fermi_Dirac_integrals_k2(0);
