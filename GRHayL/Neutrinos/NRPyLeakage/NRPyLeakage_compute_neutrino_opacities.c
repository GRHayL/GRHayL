...
void NRPyLeakage_compute_neutrino_opacities(
  ...
  const double tmp_5 = NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_4);
  const double tmp_6 = NRPyLeakage_N_A*NRPyLeakage_sigma_0*((T)*(T))*rho_cgs/((NRPyLeakage_m_e_c2)*(NRPyLeakage_m_e_c2));
  const double tmp_7 = tmp_5*tmp_6/NRPyLeakage_Fermi_Dirac_integrals_k2(tmp_4);
  ...
  const double tmp_12 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_4);
  ...
  const double tmp_15 = tmp_12/NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_4);
  ...
  const double tmp_21 = NRPyLeakage_Fermi_Dirac_integrals_k4(tmp_20);
  const double tmp_22 = tmp_21/NRPyLeakage_Fermi_Dirac_integrals_k2(tmp_20);
  const double tmp_24 = NRPyLeakage_Fermi_Dirac_integrals_k5(tmp_20);
  const double tmp_25 = Y_pn*tmp_13/(exp(-tmp_2 - tmp_24/tmp_21) + 1);
  const double tmp_26 = tmp_24/NRPyLeakage_Fermi_Dirac_integrals_k3(tmp_20);
  const double tmp_28 = NRPyLeakage_Fermi_Dirac_integrals_k4(0)/NRPyLeakage_Fermi_Dirac_integrals_k2(0);
  const double tmp_30 = NRPyLeakage_Fermi_Dirac_integrals_k5(0)/NRPyLeakage_Fermi_Dirac_integrals_k3(0);
  ...
  kappa->anue[1] = NRPyLeakage_units_geom_to_cgs_L*(EnsureFinite(tmp_17*tmp_26) + EnsureFinite(tmp_10*tmp_26*tmp_6) + EnsureFinite(tmp_25*tmp_26*tmp_6));
