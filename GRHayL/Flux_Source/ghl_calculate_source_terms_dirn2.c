 ...
 */
void ghl_calculate_source_terms_dirn2(ghl_primitive_quantities *restrict prims, struct ghl_eos_parameters const *restrict eos, const ghl_metric_quantities *restrict metric, const ghl_metric_quantities *restrict metric_derivs, ghl_conservative_quantities *restrict cons) {
...
const double alpha_dD2 = metric_derivs->lapse;
const double betaU_dD02 = metric_derivs->betaU[0];
const double betaU_dD12 = metric_derivs->betaU[1];
const double betaU_dD22 = metric_derivs->betaU[2];
const double gammaDD_dD002 = metric_derivs->gammaDD[0][0];
const double gammaDD_dD012 = metric_derivs->gammaDD[0][1];
const double gammaDD_dD022 = metric_derivs->gammaDD[0][2];
const double gammaDD_dD112 = metric_derivs->gammaDD[1][1];
const double gammaDD_dD122 = metric_derivs->gammaDD[1][2];
const double gammaDD_dD222 = metric_derivs->gammaDD[2][2];
