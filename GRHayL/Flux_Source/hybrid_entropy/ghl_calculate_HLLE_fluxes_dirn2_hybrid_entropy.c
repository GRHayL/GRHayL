...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  cons->rho = -dissipation_speed*(-tmp_79 + tmp_81) + rhob_l*tmp_42*u4lU3 + rhob_r*tmp_69*u4rU3;
  ...
  cons->entropy = S_l*tmp_42*u4lU3 + S_r*tmp_69*u4rU3 - dissipation_speed*(-S_l*tmp_41*u4lU0 + S_r*alpha_face*tmp_40*u4rU0);
}
return ghl_success;
}

void ghl_calculate_HLLE_fluxes_dirn2_hybrid_entropy(ghl_primitive_quantities *restrict prims_r, ghl_primitive_quantities *restrict prims_l, const ghl_eos_parameters *restrict eos, const ghl_metric_quantities *restrict metric_face, const double cmin_dirn2, const double cmax_dirn2, ghl_conservative_quantities *restrict cons) {
  ghl_abort_if_error(ghl_calculate_HLLE_fluxes_dirn2_hybrid_entropy_checked(prims_r, prims_l, eos, metric_face, cmin_dirn2, cmax_dirn2, cons));
}
