 ...
 */
void ghl_calculate_HLLE_fluxes_dirn0_hybrid_entropy(const primitive_quantities *restrict prims_r, const primitive_quantities *restrict prims_l, struct eos_parameters const *restrict eos, const metric_quantities *restrict metric_face, const double cmin_dirn0, const double cmax_dirn0, conservative_quantities *restrict cons) {
...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  cons->SD[0] = tmp_0*(tmp_43*(gamma_faceDD00*tmp_31 + gamma_faceDD01*tmp_38 + gamma_faceDD02*tmp_40 + tmp_1*tmp_34) + tmp_70*(gamma_faceDD00*tmp_63 + gamma_faceDD01*tmp_68 + gamma_faceDD02*tmp_69 + tmp_1*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD00*tmp_66 + gamma_faceDD01*tmp_75 + gamma_faceDD02*tmp_76 + tmp_1*tmp_74) - tmp_42*(gamma_faceDD00*tmp_34 + gamma_faceDD01*tmp_72 + gamma_faceDD02*tmp_73 + tmp_1*tmp_71)));
  cons->SD[1] = tmp_0*(tmp_43*(gamma_faceDD01*tmp_31 + gamma_faceDD11*tmp_38 + gamma_faceDD12*tmp_40 + tmp_2*tmp_34) + tmp_70*(gamma_faceDD01*tmp_63 + gamma_faceDD11*tmp_68 + gamma_faceDD12*tmp_69 + tmp_2*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD01*tmp_66 + gamma_faceDD11*tmp_75 + gamma_faceDD12*tmp_76 + tmp_2*tmp_74) - tmp_42*(gamma_faceDD01*tmp_34 + gamma_faceDD11*tmp_72 + gamma_faceDD12*tmp_73 + tmp_2*tmp_71)));
  cons->SD[2] = tmp_0*(tmp_43*(gamma_faceDD02*tmp_31 + gamma_faceDD12*tmp_38 + gamma_faceDD22*tmp_40 + tmp_3*tmp_34) + tmp_70*(gamma_faceDD02*tmp_63 + gamma_faceDD12*tmp_68 + gamma_faceDD22*tmp_69 + tmp_3*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD02*tmp_66 + gamma_faceDD12*tmp_75 + gamma_faceDD22*tmp_76 + tmp_3*tmp_74) - tmp_42*(gamma_faceDD02*tmp_34 + gamma_faceDD12*tmp_72 + gamma_faceDD22*tmp_73 + tmp_3*tmp_71)));
  cons->rho = tmp_0*(rhob_l*tmp_43*u4lU1 + rhob_r*tmp_70*u4rU1 - tmp_77*(-tmp_81 + tmp_83));
  cons->tau = tmp_0*(cmax_dirn0*(-rhob_l*tmp_42*u4lU1 + tmp_34*tmp_84) + cmin_dirn0*(-rhob_r*tmp_42*u4rU1 + tmp_66*tmp_84) - tmp_77*(tmp_41*tmp_7*tmp_74 - tmp_71*tmp_84 + tmp_81 - tmp_83));
  cons->entropy = tmp_0*(S_l*tmp_43*u4lU1 + S_r*tmp_70*u4rU1 - tmp_77*(-S_l*tmp_42*u4lU0 + S_r*alpha_face*tmp_41*u4rU0));
}
}
