 ...
 */
void ghl_calculate_HLLE_fluxes_dirn1_hybrid_entropy(const primitive_quantities *restrict prims_r, const primitive_quantities *restrict prims_l, struct eos_parameters const *restrict eos, const metric_quantities *restrict metric_face, const double cmin_dirn1, const double cmax_dirn1, conservative_quantities *restrict cons) {
...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_21 = gamma_faceDD01*tmp_14 + gamma_faceDD02*tmp_10*tmp_12*tmp_15 + gamma_faceDD12*tmp_16 + tmp_1*tmp_12*tmp_17 + tmp_15*tmp_17*tmp_3 + tmp_17*tmp_2*tmp_5;
  const double tmp_22 = beta_faceU0*tmp_1 + beta_faceU1*tmp_2 + beta_faceU2*tmp_3 - tmp_7;
  const double tmp_23 = ((tmp_4)*(tmp_4))*tmp_9;
  const double tmp_24 = gamma_faceDD00*tmp_10*((tmp_12)*(tmp_12)) + gamma_faceDD11*tmp_11 + gamma_faceDD22*tmp_10*((tmp_15)*(tmp_15)) + tmp_22*tmp_23;
  ...
  const double tmp_29 = -((beta_faceU1)*(beta_faceU1))*tmp_8 + tmp_28*(gamma_faceDD00*gamma_faceDD22 - ((gamma_faceDD02)*(gamma_faceDD02)));
  const double tmp_30 = P_l + _Rational_1_2*tmp_24 + tmp_21;
  const double tmp_31 = -tmp_11 + tmp_25*((u4lU2)*(u4lU2)) + tmp_29*tmp_30;
  const double tmp_32 = tmp_30*tmp_8;
  const double tmp_33 = tmp_25*u4lU0;
  const double tmp_34 = beta_faceU1*tmp_32 - tmp_17*tmp_5 + tmp_33*u4lU2;
  ...
  const double tmp_43 = cmax_dirn1*tmp_42;
  ...
  const double tmp_45 = BrU1 + tmp_44*u4rU2;
  ...
  const double tmp_58 = gamma_faceDD01*tmp_51 + gamma_faceDD02*tmp_47*tmp_49*tmp_52 + gamma_faceDD12*tmp_53 + tmp_1*tmp_49*tmp_54 + tmp_2*tmp_45*tmp_54 + tmp_3*tmp_52*tmp_54;
  const double tmp_59 = ((tmp_44)*(tmp_44))*tmp_9;
  const double tmp_60 = gamma_faceDD00*tmp_47*((tmp_49)*(tmp_49)) + gamma_faceDD11*tmp_48 + gamma_faceDD22*tmp_47*((tmp_52)*(tmp_52)) + tmp_22*tmp_59;
  const double tmp_61 = _Integer_2*tmp_58 + h_r*rhob_r + tmp_60;
  const double tmp_62 = P_r + _Rational_1_2*tmp_60 + tmp_58;
  const double tmp_63 = tmp_29*tmp_62 - tmp_48 + tmp_61*((u4rU2)*(u4rU2));
  const double tmp_64 = tmp_62*tmp_8;
  const double tmp_65 = tmp_61*u4rU0;
  const double tmp_66 = beta_faceU1*tmp_64 - tmp_45*tmp_54 + tmp_65*u4rU2;
  const double tmp_68 = tmp_37*tmp_62 - tmp_51 + tmp_61*u4rU1*u4rU2;
  const double tmp_69 = tmp_39*tmp_62 - tmp_53 + tmp_61*u4rU2*u4rU3;
  const double tmp_70 = cmin_dirn1*tmp_42;
  ...
  const double tmp_77 = cmax_dirn1*cmin_dirn1;
  const double tmp_81 = rhob_l*tmp_42*u4lU0;
  const double tmp_83 = rhob_r*tmp_42*u4rU0;
  const double tmp_84 = tmp_41*tmp_7;
  cons->SD[0] = tmp_0*(tmp_43*(gamma_faceDD00*tmp_38 + gamma_faceDD01*tmp_31 + gamma_faceDD02*tmp_40 + tmp_1*tmp_34) + tmp_70*(gamma_faceDD00*tmp_68 + gamma_faceDD01*tmp_63 + gamma_faceDD02*tmp_69 + tmp_1*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD00*tmp_75 + gamma_faceDD01*tmp_66 + gamma_faceDD02*tmp_76 + tmp_1*tmp_74) - tmp_42*(gamma_faceDD00*tmp_72 + gamma_faceDD01*tmp_34 + gamma_faceDD02*tmp_73 + tmp_1*tmp_71)));
  cons->SD[1] = tmp_0*(tmp_43*(gamma_faceDD01*tmp_38 + gamma_faceDD11*tmp_31 + gamma_faceDD12*tmp_40 + tmp_2*tmp_34) + tmp_70*(gamma_faceDD01*tmp_68 + gamma_faceDD11*tmp_63 + gamma_faceDD12*tmp_69 + tmp_2*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD01*tmp_75 + gamma_faceDD11*tmp_66 + gamma_faceDD12*tmp_76 + tmp_2*tmp_74) - tmp_42*(gamma_faceDD01*tmp_72 + gamma_faceDD11*tmp_34 + gamma_faceDD12*tmp_73 + tmp_2*tmp_71)));
  cons->SD[2] = tmp_0*(tmp_43*(gamma_faceDD02*tmp_38 + gamma_faceDD12*tmp_31 + gamma_faceDD22*tmp_40 + tmp_3*tmp_34) + tmp_70*(gamma_faceDD02*tmp_68 + gamma_faceDD12*tmp_63 + gamma_faceDD22*tmp_69 + tmp_3*tmp_66) - tmp_77*(alpha_face*tmp_41*(gamma_faceDD02*tmp_75 + gamma_faceDD12*tmp_66 + gamma_faceDD22*tmp_76 + tmp_3*tmp_74) - tmp_42*(gamma_faceDD02*tmp_72 + gamma_faceDD12*tmp_34 + gamma_faceDD22*tmp_73 + tmp_3*tmp_71)));
  cons->rho = tmp_0*(rhob_l*tmp_43*u4lU2 + rhob_r*tmp_70*u4rU2 - tmp_77*(-tmp_81 + tmp_83));
  cons->tau = tmp_0*(cmax_dirn1*(-rhob_l*tmp_42*u4lU2 + tmp_34*tmp_84) + cmin_dirn1*(-rhob_r*tmp_42*u4rU2 + tmp_66*tmp_84) - tmp_77*(tmp_41*tmp_7*tmp_74 - tmp_71*tmp_84 + tmp_81 - tmp_83));
  cons->entropy = tmp_0*(S_l*tmp_43*u4lU2 + S_r*tmp_70*u4rU2 - tmp_77*(-S_l*tmp_42*u4lU0 + S_r*alpha_face*tmp_41*u4rU0));
}
}
