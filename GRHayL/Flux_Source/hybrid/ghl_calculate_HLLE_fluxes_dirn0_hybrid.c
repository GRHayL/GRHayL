...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  cons->rho = -dissipation_speed*(-tmp_77 + tmp_79) + rhob_l*tmp_42*u4lU1 + rhob_r*tmp_69*u4rU1;
  cons->tau = cmax_weight*(-rhob_l*tmp_41*u4lU1 + tmp_33*tmp_80) + cmin_weight*(-rhob_r*tmp_41*u4rU1 + tmp_65*tmp_80) - dissipation_speed*(tmp_40*tmp_6*tmp_73 - tmp_70*tmp_80 + tmp_77 - tmp_79);
}
return ghl_success;
}
