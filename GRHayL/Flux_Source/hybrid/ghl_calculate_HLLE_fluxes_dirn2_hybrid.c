...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_77 = rhob_l*tmp_41*u4lU0;
  const double tmp_79 = rhob_r*tmp_41*u4rU0;
  const double tmp_80 = tmp_40*tmp_6;
  ...
  cons->rho = -dissipation_speed*(-tmp_77 + tmp_79) + rhob_l*tmp_42*u4lU3 + rhob_r*tmp_69*u4rU3;
  cons->tau = cmax_weight*(-rhob_l*tmp_41*u4lU3 + tmp_33*tmp_80) + cmin_weight*(-rhob_r*tmp_41*u4rU3 + tmp_65*tmp_80) - dissipation_speed*(tmp_40*tmp_6*tmp_73 - tmp_70*tmp_80 + tmp_77 - tmp_79);
}
return ghl_success;
}

void ghl_calculate_HLLE_fluxes_dirn2_hybrid(ghl_primitive_quantities *restrict prims_r, ghl_primitive_quantities *restrict prims_l, const ghl_eos_parameters *restrict eos, const ghl_metric_quantities *restrict metric_face, const double cmin_dirn2, const double cmax_dirn2, ghl_conservative_quantities *restrict cons) {
  ghl_abort_if_error(ghl_calculate_HLLE_fluxes_dirn2_hybrid_checked(prims_r, prims_l, eos, metric_face, cmin_dirn2, cmax_dirn2, cons));
}
