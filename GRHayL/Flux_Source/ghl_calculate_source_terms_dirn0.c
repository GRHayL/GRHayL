 ...
 */
void ghl_calculate_source_terms_dirn0(ghl_primitive_quantities *restrict prims, struct ghl_eos_parameters const *restrict eos, const ghl_metric_quantities *restrict metric, const ghl_metric_quantities *restrict metric_derivs, ghl_conservative_quantities *restrict cons) {
