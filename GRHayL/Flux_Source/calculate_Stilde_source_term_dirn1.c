...
/*
 * Add source term for 1-component of Stilde
 */
void calculate_Stilde_source_term_dirn1(const primitive_quantities *restrict prims, struct eos_parameters const *restrict eos, const metric_quantities *restrict metric, const metric_derivatives *restrict metric_derivs, conservative_quantities *restrict cons) {
...
const double gammaDD_dD221 = metric_derivs->adm_gzz[1];
  ...
  const double tmp_36 = betaU0*gammaDD_dD011 + betaU1*gammaDD_dD111 + betaU2*gammaDD_dD121 + betaU_dD01*gammaDD01 + betaU_dD11*gammaDD11 + betaU_dD21*gammaDD12;
  const double tmp_38 = betaU0*gammaDD_dD021 + betaU1*gammaDD_dD121 + betaU2*gammaDD_dD221 + betaU_dD01*gammaDD02 + betaU_dD11*gammaDD12 + betaU_dD21*gammaDD22;
  const double tmp_40 = (1.0/(tmp_34));
  cons->S_y = _Rational_1_2*(gammaDD_dD001*tmp_35*(-tmp_13 + tmp_27*(-((betaU0)*(betaU0))*tmp_7 + tmp_40*(gammaDD11*gammaDD22 - ((gammaDD12)*(gammaDD12)))) + tmp_29*((u4U1)*(u4U1))) + gammaDD_dD111*tmp_35*(-tmp_15 + tmp_27*(-((betaU1)*(betaU1))*tmp_7 + tmp_40*(gammaDD00*gammaDD22 - ((gammaDD02)*(gammaDD02)))) + tmp_29*((u4U2)*(u4U2))) + gammaDD_dD221*tmp_35*(-tmp_17 + tmp_27*(-((betaU2)*(betaU2))*tmp_7 + tmp_40*(gammaDD00*gammaDD11 - ((gammaDD01)*(gammaDD01)))) + tmp_29*((u4U3)*(u4U3))) + tmp_35*(-tmp_18 - tmp_28 + tmp_29*((u4U0)*(u4U0)))*(-_Integer_2*alpha*alpha_dD1 + betaU0*tmp_0 + betaU1*tmp_36 + betaU2*tmp_38 + betaU_dD01*tmp_1 + betaU_dD11*tmp_2 + betaU_dD21*tmp_3)) + gammaDD_dD011*tmp_35*(-tmp_21 + tmp_27*(-betaU0*betaU1*tmp_7 + tmp_40*(-gammaDD01*gammaDD22 + gammaDD02*gammaDD12)) + tmp_30*u4U2) + gammaDD_dD021*tmp_35*(-tmp_22 + tmp_27*(-betaU0*betaU2*tmp_7 + tmp_40*(gammaDD01*gammaDD12 - gammaDD02*gammaDD11)) + tmp_30*u4U3) + gammaDD_dD121*tmp_35*(-tmp_23 + tmp_27*(-betaU1*betaU2*tmp_7 + tmp_40*(-gammaDD00*gammaDD12 + gammaDD01*gammaDD02)) + tmp_29*u4U2*u4U3) + tmp_0*tmp_35*(betaU0*tmp_28 + tmp_30*u4U0 - tmp_5*tmp_9) + tmp_35*tmp_36*(betaU1*tmp_28 - tmp_14*tmp_9 + tmp_29*u4U0*u4U2) + tmp_35*tmp_38*(betaU2*tmp_28 - tmp_16*tmp_9 + tmp_29*u4U0*u4U3);
}
}
