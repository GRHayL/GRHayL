...
const double gamma_faceDD22 = metric_face->adm_gzz;
  ...
  const double tmp_29 = -beta_faceU0*tmp_1*(2*tmp_21 + 2*tmp_23) + 2*tmp_26*u4lU0*u4lU1;
  ...
  const double tmp_48 = -beta_faceU0*tmp_1*(2*tmp_40 + 2*tmp_42) + 2*tmp_45*u4rU0*u4rU1;
  const double tmp_52 = -1.0/4.0*tmp_28*tmp_29;
  const double tmp_54 = (1.0/4.0)*tmp_47*tmp_48;
  const double tmp_55 = (1.0/2.0)*tmp_28;
  const double tmp_58 = -((beta_faceU0)*(beta_faceU0))*tmp_1 + (gamma_faceDD11*gamma_faceDD22 - ((gamma_faceDD12)*(gamma_faceDD12)))/(gamma_faceDD00*gamma_faceDD11*gamma_faceDD22 - gamma_faceDD00*((gamma_faceDD12)*(gamma_faceDD12)) - ((gamma_faceDD01)*(gamma_faceDD01))*gamma_faceDD22 + 2*gamma_faceDD01*gamma_faceDD02*gamma_faceDD12 - ((gamma_faceDD02)*(gamma_faceDD02))*gamma_faceDD11);
  const double tmp_59 = (4*tmp_25 + 4*tmp_27)*(tmp_26*((u4lU1)*(u4lU1)) - tmp_58*(tmp_21 + tmp_23));
  ...
  const double tmp_63 = (4*tmp_44 + 4*tmp_46)*(tmp_45*((u4rU1)*(u4rU1)) - tmp_58*(tmp_40 + tmp_42));
  ...
  *cmin_dirn0 = (1.0/4.0)*tmp_66 - tmp_73 - tmp_75 + tmp_76 + tmp_77 + tmp_78 + (1.0/2.0)*fabs((1.0/8.0)*tmp_28*tmp_29 + (1.0/8.0)*tmp_47*tmp_48 - 1.0/2.0*tmp_66 - tmp_68 - tmp_70 - tmp_71);
  *cmax_dirn0 = tmp_73 + tmp_75 - tmp_76 - tmp_77 + tmp_78 + (1.0/4.0)*tmp_79 + (1.0/2.0)*fabs((1.0/8.0)*tmp_28*tmp_29 + (1.0/8.0)*tmp_47*tmp_48 - tmp_68 - tmp_70 + tmp_71 + (1.0/2.0)*tmp_79);
}
}
