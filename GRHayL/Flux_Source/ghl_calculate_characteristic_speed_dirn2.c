...
void ghl_calculate_characteristic_speed_dirn2(
...

  {
    ...
    const double tmp_22 = -beta_faceU2 * tmp_1 * tmp_19 + tmp_21 * u4lU0 * u4lU3;
    ...
    const double tmp_40 = -beta_faceU2 * tmp_1 * tmp_38 + tmp_39 * u4rU0 * u4rU3;
    ...
    const double tmp_52 = -((beta_faceU2) * (beta_faceU2)) * tmp_1
    ...
    const double tmp_53 = ((_Integer_2) * (_Integer_2)) * ((tmp_22) * (tmp_22))
                        - _Integer_4 * tmp_24 * (-tmp_19 * tmp_52 + tmp_21 * ((u4lU3) * (u4lU3)));
    ...
    const double tmp_55 = ((_Integer_2) * (_Integer_2)) * ((tmp_40) * (tmp_40))
                        - _Integer_4 * tmp_42 * (-tmp_38 * tmp_52 + tmp_39 * ((u4rU3) * (u4rU3)));
