...
const double alpha_dD1 = metric_derivs[1].lapse;
const double betaU_dD01 = metric_derivs[1].betaU[0];
const double betaU_dD11 = metric_derivs[1].betaU[1];
const double betaU_dD21 = metric_derivs[1].betaU[2];
const double gammaDD_dD001 = metric_derivs[1].gammaDD[0][0];
const double gammaDD_dD011 = metric_derivs[1].gammaDD[0][1];
const double gammaDD_dD021 = metric_derivs[1].gammaDD[0][2];
const double gammaDD_dD111 = metric_derivs[1].gammaDD[1][1];
const double gammaDD_dD121 = metric_derivs[1].gammaDD[1][2];
const double gammaDD_dD221 = metric_derivs[1].gammaDD[2][2];
