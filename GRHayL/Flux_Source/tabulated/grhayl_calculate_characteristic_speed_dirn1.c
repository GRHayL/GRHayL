 ...
 */
void ghl_calculate_characteristic_speed_dirn1(const ghl_primitive_quantities *restrict prims_r, const ghl_primitive_quantities *restrict prims_l, struct ghl_eos_parameters const *restrict eos, const ghl_metric_quantities *restrict metric_face, double *cmin_dirn1, double *cmax_dirn1) {
