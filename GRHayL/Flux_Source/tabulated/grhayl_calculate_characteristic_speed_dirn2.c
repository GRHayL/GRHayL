 ...
 */
void ghl_calculate_characteristic_speed_dirn2(const primitive_quantities *restrict prims_r, const primitive_quantities *restrict prims_l, struct eos_parameters const *restrict eos, const metric_quantities *restrict metric_face, double *cmin_dirn2, double *cmax_dirn2) {
