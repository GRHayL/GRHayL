 ...
 */
void ghl_calculate_characteristic_speed_dirn2(const ghl_primitive_quantities *restrict prims_r, const ghl_primitive_quantities *restrict prims_l, struct ghl_eos_parameters const *restrict eos, const ghl_metric_quantities *restrict metric_face, double *cmin_dirn2, double *cmax_dirn2) {
...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_52 = -((beta_faceU2)*(beta_faceU2))*tmp_1 + (gamma_faceDD00*gamma_faceDD11 - ((gamma_faceDD01)*(gamma_faceDD01)))/(_Integer_2*gamma_faceDD01*gamma_faceDD02*gamma_faceDD12 + gamma_faceDD00*gamma_faceDD11*gamma_faceDD22 - gamma_faceDD00*((gamma_faceDD12)*(gamma_faceDD12)) - ((gamma_faceDD01)*(gamma_faceDD01))*gamma_faceDD22 - ((gamma_faceDD02)*(gamma_faceDD02))*gamma_faceDD11);
  const double tmp_53 = ((_Integer_2)*(_Integer_2))*((tmp_22)*(tmp_22)) - _Integer_4*tmp_24*(-tmp_19*tmp_52 + tmp_21*((u4lU3)*(u4lU3)));
  const double tmp_54 = fabs(_Integer_2*_Rational_1_2*(tmp_22*tmp_25 + tmp_26) + tmp_25*sqrt(_Rational_1_2*(tmp_53 + fabs(tmp_53))));
  const double tmp_55 = ((_Integer_2)*(_Integer_2))*((tmp_40)*(tmp_40)) - _Integer_4*tmp_42*(-tmp_38*tmp_52 + tmp_39*((u4rU3)*(u4rU3)));
  ...
  *cmin_dirn2 = _Integer_2*_Rational_1_16*tmp_47 + _Rational_1_2*fabs(-_Rational_1_2*tmp_61 - _Rational_1_4*tmp_57 + _Rational_1_8*tmp_62) + _Rational_1_4*tmp_61 + _Rational_1_8*tmp_57;
