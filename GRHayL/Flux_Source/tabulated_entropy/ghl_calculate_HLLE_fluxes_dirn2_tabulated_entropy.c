...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_77 = rhob_l*tmp_42*u4lU3;
  const double tmp_79 = rhob_r*tmp_69*u4rU3;
  const double tmp_81 = rhob_l*tmp_41*u4lU0;
  const double tmp_83 = rhob_r*tmp_41*u4rU0;
  const double tmp_84 = tmp_40*tmp_6;
  ...
  cons->rho = -dissipation_speed*(-tmp_81 + tmp_83) + tmp_77 + tmp_79;
  cons->tau = cmax_weight*(-rhob_l*tmp_41*u4lU3 + tmp_33*tmp_84) + cmin_weight*(-rhob_r*tmp_41*u4rU3 + tmp_65*tmp_84) - dissipation_speed*(tmp_40*tmp_6*tmp_73 - tmp_70*tmp_84 + tmp_81 - tmp_83);
