...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_4 = BlU1 + tmp_3*u4lU2;
  ...
  const double tmp_20 = gamma_faceDD01*tmp_13 + gamma_faceDD02*tmp_11*tmp_14*tmp_9 + gamma_faceDD12*tmp_15 + tmp_0*tmp_11*tmp_16 + tmp_1*tmp_16*tmp_4 + tmp_14*tmp_16*tmp_2;
  const double tmp_21 = beta_faceU0*tmp_0 + beta_faceU1*tmp_1 + beta_faceU2*tmp_2 - tmp_6;
  const double tmp_22 = ((tmp_3)*(tmp_3))*tmp_8;
  const double tmp_23 = gamma_faceDD00*((tmp_11)*(tmp_11))*tmp_9 + gamma_faceDD11*tmp_10 + gamma_faceDD22*((tmp_14)*(tmp_14))*tmp_9 + tmp_21*tmp_22;
  ...
  const double tmp_28 = -((beta_faceU1)*(beta_faceU1))*tmp_7 + tmp_27*(gamma_faceDD00*gamma_faceDD22 - ((gamma_faceDD02)*(gamma_faceDD02)));
  const double tmp_29 = P_l + _Rational_1_2*tmp_23 + tmp_20;
  const double tmp_30 = -tmp_10 + tmp_24*((u4lU2)*(u4lU2)) + tmp_28*tmp_29;
  const double tmp_31 = tmp_29*tmp_7;
  const double tmp_32 = tmp_24*u4lU0;
  const double tmp_33 = beta_faceU1*tmp_31 - tmp_16*tmp_4 + tmp_32*u4lU2;
  ...
  const double tmp_44 = BrU1 + tmp_43*u4rU2;
  ...
  const double tmp_57 = gamma_faceDD01*tmp_50 + gamma_faceDD02*tmp_46*tmp_48*tmp_51 + gamma_faceDD12*tmp_52 + tmp_0*tmp_48*tmp_53 + tmp_1*tmp_44*tmp_53 + tmp_2*tmp_51*tmp_53;
  const double tmp_58 = ((tmp_43)*(tmp_43))*tmp_8;
  const double tmp_59 = gamma_faceDD00*tmp_46*((tmp_48)*(tmp_48)) + gamma_faceDD11*tmp_47 + gamma_faceDD22*tmp_46*((tmp_51)*(tmp_51)) + tmp_21*tmp_58;
  const double tmp_60 = _Integer_2*tmp_57 + h_r*rhob_r + tmp_59;
  const double tmp_61 = P_r + _Rational_1_2*tmp_59 + tmp_57;
  const double tmp_62 = tmp_28*tmp_61 - tmp_47 + tmp_60*((u4rU2)*(u4rU2));
  const double tmp_63 = tmp_61*tmp_7;
  const double tmp_64 = tmp_60*u4rU0;
  const double tmp_65 = beta_faceU1*tmp_63 - tmp_44*tmp_53 + tmp_64*u4rU2;
  ...
  const double tmp_77 = rhob_l*tmp_42*u4lU2;
  const double tmp_79 = rhob_r*tmp_69*u4rU2;
  const double tmp_81 = rhob_l*tmp_41*u4lU0;
  const double tmp_83 = rhob_r*tmp_41*u4rU0;
  const double tmp_84 = tmp_40*tmp_6;
  cons->SD[0] = -dissipation_speed*(alpha_face*tmp_40*(gamma_faceDD00*tmp_74 + gamma_faceDD01*tmp_65 + gamma_faceDD02*tmp_75 + tmp_0*tmp_73) - tmp_41*(gamma_faceDD00*tmp_71 + gamma_faceDD01*tmp_33 + gamma_faceDD02*tmp_72 + tmp_0*tmp_70)) + tmp_42*(gamma_faceDD00*tmp_37 + gamma_faceDD01*tmp_30 + gamma_faceDD02*tmp_39 + tmp_0*tmp_33) + tmp_69*(gamma_faceDD00*tmp_67 + gamma_faceDD01*tmp_62 + gamma_faceDD02*tmp_68 + tmp_0*tmp_65);
  cons->SD[1] = -dissipation_speed*(alpha_face*tmp_40*(gamma_faceDD01*tmp_74 + gamma_faceDD11*tmp_65 + gamma_faceDD12*tmp_75 + tmp_1*tmp_73) - tmp_41*(gamma_faceDD01*tmp_71 + gamma_faceDD11*tmp_33 + gamma_faceDD12*tmp_72 + tmp_1*tmp_70)) + tmp_42*(gamma_faceDD01*tmp_37 + gamma_faceDD11*tmp_30 + gamma_faceDD12*tmp_39 + tmp_1*tmp_33) + tmp_69*(gamma_faceDD01*tmp_67 + gamma_faceDD11*tmp_62 + gamma_faceDD12*tmp_68 + tmp_1*tmp_65);
  cons->SD[2] = -dissipation_speed*(alpha_face*tmp_40*(gamma_faceDD02*tmp_74 + gamma_faceDD12*tmp_65 + gamma_faceDD22*tmp_75 + tmp_2*tmp_73) - tmp_41*(gamma_faceDD02*tmp_71 + gamma_faceDD12*tmp_33 + gamma_faceDD22*tmp_72 + tmp_2*tmp_70)) + tmp_42*(gamma_faceDD02*tmp_37 + gamma_faceDD12*tmp_30 + gamma_faceDD22*tmp_39 + tmp_2*tmp_33) + tmp_69*(gamma_faceDD02*tmp_67 + gamma_faceDD12*tmp_62 + gamma_faceDD22*tmp_68 + tmp_2*tmp_65);
  cons->rho = -dissipation_speed*(-tmp_81 + tmp_83) + tmp_77 + tmp_79;
  cons->tau = cmax_weight*(-rhob_l*tmp_41*u4lU2 + tmp_33*tmp_84) + cmin_weight*(-rhob_r*tmp_41*u4rU2 + tmp_65*tmp_84) - dissipation_speed*(tmp_40*tmp_6*tmp_73 - tmp_70*tmp_84 + tmp_81 - tmp_83);
  cons->entropy = S_l*tmp_42*u4lU2 + S_r*tmp_69*u4rU2 - dissipation_speed*(-S_l*tmp_41*u4lU0 + S_r*alpha_face*tmp_40*u4rU0);
...
void ghl_calculate_HLLE_fluxes_dirn1_tabulated_entropy(ghl_primitive_quantities *restrict prims_r, ghl_primitive_quantities *restrict prims_l, const ghl_eos_parameters *restrict eos, const ghl_metric_quantities *restrict metric_face, const double cmin_dirn1, const double cmax_dirn1, ghl_conservative_quantities *restrict cons) {
  ghl_abort_if_error(ghl_calculate_HLLE_fluxes_dirn1_tabulated_entropy_checked(prims_r, prims_l, eos, metric_face, cmin_dirn1, cmax_dirn1, cons));
}
