...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_79 = rhob_l*tmp_43*u4lU2;
  const double tmp_81 = rhob_r*tmp_70*u4rU2;
  ...
  cons->tau = tmp_0*(cmax_dirn1*(-rhob_l*tmp_42*u4lU2 + tmp_34*tmp_86) + cmin_dirn1*(-rhob_r*tmp_42*u4rU2 + tmp_66*tmp_86) - tmp_77*(tmp_41*tmp_7*tmp_74 - tmp_71*tmp_86 + tmp_83 - tmp_85));
