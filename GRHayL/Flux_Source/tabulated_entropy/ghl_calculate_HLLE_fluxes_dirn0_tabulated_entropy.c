...
const double gamma_faceDD22 = metric_face->gammaDD[2][2];
  ...
  const double tmp_77 = rhob_l*tmp_42*u4lU1;
  const double tmp_79 = rhob_r*tmp_69*u4rU1;
  ...
  cons->tau = cmax_weight*(-rhob_l*tmp_41*u4lU1 + tmp_33*tmp_84) + cmin_weight*(-rhob_r*tmp_41*u4rU1 + tmp_65*tmp_84) - dissipation_speed*(tmp_40*tmp_6*tmp_73 - tmp_70*tmp_84 + tmp_81 - tmp_83);
...
void ghl_calculate_HLLE_fluxes_dirn0_tabulated_entropy(ghl_primitive_quantities *restrict prims_r, ghl_primitive_quantities *restrict prims_l, const ghl_eos_parameters *restrict eos, const ghl_metric_quantities *restrict metric_face, const double cmin_dirn0, const double cmax_dirn0, ghl_conservative_quantities *restrict cons) {
  ghl_abort_if_error(ghl_calculate_HLLE_fluxes_dirn0_tabulated_entropy_checked(prims_r, prims_l, eos, metric_face, cmin_dirn0, cmax_dirn0, cons));
}
