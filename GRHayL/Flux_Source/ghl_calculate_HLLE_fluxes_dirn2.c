 ...
 */
void ghl_calculate_HLLE_fluxes_dirn2(const primitive_quantities *restrict prims_r, const primitive_quantities *restrict prims_l, struct eos_parameters const *restrict eos, const metric_quantities *restrict metric_face, const double cmin_dirn2, const double cmax_dirn2, conservative_quantities *restrict cons) {
