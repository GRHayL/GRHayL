...
void ghl_calculate_characteristic_speed_dirn1(
...

  {
    ...
    //     prims_r->temperature, prims_r->press, prims_r->eps, prims_l->rho, prims_l->Y_e,
    //     prims_l->temperature, prims_l->press, prims_l->eps);
    ...
    // printf(
    //     "P: %e %e %e -> %e %e | %e %e %e -> %e %e\n",
    //     prims_r->rho, prims_r->Y_e, prims_r->temperature, prims_r->press, prims_r->eps,
    //     prims_l->rho, prims_l->Y_e, prims_l->temperature, prims_l->press, prims_l->eps);
    // // clang-format on
    // printf("h: %e %e\n", h_r, h_l);
    // printf("cs2: %e %e\n", cs2_r, cs2_l);
    ...
    const double tmp_2 = beta_faceU0 * gamma_faceDD00 + beta_faceU1 * gamma_faceDD01
                       + beta_faceU2 * gamma_faceDD02;
    const double tmp_3 = beta_faceU0 * gamma_faceDD01 + beta_faceU1 * gamma_faceDD11
                       + beta_faceU2 * gamma_faceDD12;
    const double tmp_4 = beta_faceU0 * gamma_faceDD02 + beta_faceU1 * gamma_faceDD12
                       + beta_faceU2 * gamma_faceDD22;
    const double tmp_5 = BlU0
                           * (gamma_faceDD00 * u4lU1 + gamma_faceDD01 * u4lU2
                              + gamma_faceDD02 * u4lU3 + tmp_2 * u4lU0)
                       + BlU1
                             * (gamma_faceDD01 * u4lU1 + gamma_faceDD11 * u4lU2
                                + gamma_faceDD12 * u4lU3 + tmp_3 * u4lU0)
                       + BlU2
                             * (gamma_faceDD02 * u4lU1 + gamma_faceDD12 * u4lU2
                                + gamma_faceDD22 * u4lU3 + tmp_4 * u4lU0);
    ...
    const double tmp_12 = tmp_8
                        * (-((alpha_face) * (alpha_face)) + beta_faceU0 * tmp_2
                           + beta_faceU1 * tmp_3 + beta_faceU2 * tmp_4);
    const double tmp_15 = tmp_5 / u4lU0;
    const double tmp_17
        = _Integer_2
            * (gamma_faceDD01 * tmp_10 * tmp_6 * tmp_9 + gamma_faceDD02 * tmp_11 * tmp_6 * tmp_9
               + gamma_faceDD12 * tmp_10 * tmp_11 * tmp_9 + tmp_10 * tmp_15 * tmp_3 * tmp_8
               + tmp_11 * tmp_15 * tmp_4 * tmp_8 + tmp_15 * tmp_2 * tmp_6 * tmp_8)
        + gamma_faceDD00 * ((tmp_6) * (tmp_6)) * tmp_9
        + gamma_faceDD11 * ((tmp_10) * (tmp_10)) * tmp_9
        + gamma_faceDD22 * ((tmp_11) * (tmp_11)) * tmp_9 + tmp_12 * ((tmp_5) * (tmp_5));
    ...
    const double tmp_27 = BrU0
                            * (gamma_faceDD00 * u4rU1 + gamma_faceDD01 * u4rU2
                               + gamma_faceDD02 * u4rU3 + tmp_2 * u4rU0)
                        + BrU1
                              * (gamma_faceDD01 * u4rU1 + gamma_faceDD11 * u4rU2
                                 + gamma_faceDD12 * u4rU3 + tmp_3 * u4rU0)
                        + BrU2
                              * (gamma_faceDD02 * u4rU1 + gamma_faceDD12 * u4rU2
                                 + gamma_faceDD22 * u4rU3 + tmp_4 * u4rU0);
    ...
    const double tmp_36
        = _Integer_2
            * (gamma_faceDD01 * tmp_28 * tmp_30 * tmp_31
               + gamma_faceDD02 * tmp_28 * tmp_30 * tmp_32
               + gamma_faceDD12 * tmp_30 * tmp_31 * tmp_32 + tmp_2 * tmp_28 * tmp_34 * tmp_8
               + tmp_3 * tmp_31 * tmp_34 * tmp_8 + tmp_32 * tmp_34 * tmp_4 * tmp_8)
        + gamma_faceDD00 * ((tmp_28) * (tmp_28)) * tmp_30
        + gamma_faceDD11 * tmp_30 * ((tmp_31) * (tmp_31))
        + gamma_faceDD22 * tmp_30 * ((tmp_32) * (tmp_32)) + tmp_12 * ((tmp_27) * (tmp_27));
    ...
    const double tmp_52 = -((beta_faceU1) * (beta_faceU1)) * tmp_1
                        + (gamma_faceDD00 * gamma_faceDD22 - ((gamma_faceDD02) * (gamma_faceDD02)))
                              / (_Integer_2 * gamma_faceDD01 * gamma_faceDD02 * gamma_faceDD12
                                 + gamma_faceDD00 * gamma_faceDD11 * gamma_faceDD22
                                 - gamma_faceDD00 * ((gamma_faceDD12) * (gamma_faceDD12))
                                 - ((gamma_faceDD01) * (gamma_faceDD01)) * gamma_faceDD22
                                 - ((gamma_faceDD02) * (gamma_faceDD02)) * gamma_faceDD11);
    const double tmp_53 = ((_Integer_2) * (_Integer_2)) * ((tmp_22) * (tmp_22))
                        - _Integer_4 * tmp_24 * (-tmp_19 * tmp_52 + tmp_21 * ((u4lU2) * (u4lU2)));
    const double tmp_54 = fabs(
        _Integer_2 * _Rational_1_2 * (tmp_22 * tmp_25 + tmp_26)
        + tmp_25 * sqrt(_Rational_1_2 * (tmp_53 + fabs(tmp_53))));
    const double tmp_55 = ((_Integer_2) * (_Integer_2)) * ((tmp_40) * (tmp_40))
                        - _Integer_4 * tmp_42 * (-tmp_38 * tmp_52 + tmp_39 * ((u4rU2) * (u4rU2)));
    const double tmp_56 = fabs(
        _Integer_2 * _Rational_1_2 * (tmp_40 * tmp_43 + tmp_44)
        + tmp_43 * sqrt(_Rational_1_2 * (tmp_55 + fabs(tmp_55))));
    ...
    *cmin_dirn1
        = _Integer_2 * _Rational_1_16 * tmp_47
        + _Rational_1_2
              * fabs(-_Rational_1_2 * tmp_61 - _Rational_1_4 * tmp_57 + _Rational_1_8 * tmp_62)
        + _Rational_1_4 * tmp_61 + _Rational_1_8 * tmp_57;
    *cmax_dirn1
        = _Rational_1_16 * tmp_62
        + _Rational_1_2
              * fabs(_Rational_1_2 * tmp_64 + _Rational_1_4 * tmp_57 + _Rational_1_8 * tmp_62)
        + _Rational_1_4 * tmp_64 + _Rational_1_8 * tmp_57;
