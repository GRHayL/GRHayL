...
void ghl_calculate_characteristic_speed_dirn0(
...

  {
    ...
    const double tmp_52 = -((beta_faceU0) * (beta_faceU0)) * tmp_1
                        + (gamma_faceDD11 * gamma_faceDD22 - ((gamma_faceDD12) * (gamma_faceDD12)))
    ...
    const double tmp_53 = ((_Integer_2) * (_Integer_2)) * ((tmp_22) * (tmp_22))
                        - _Integer_4 * tmp_24 * (-tmp_19 * tmp_52 + tmp_21 * ((u4lU1) * (u4lU1)));
    ...
    const double tmp_55 = ((_Integer_2) * (_Integer_2)) * ((tmp_40) * (tmp_40))
                        - _Integer_4 * tmp_42 * (-tmp_38 * tmp_52 + tmp_39 * ((u4rU1) * (u4rU1)));
