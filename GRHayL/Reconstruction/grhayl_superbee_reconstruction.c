...
/* Function    : grhayl_superbee_reconstruction()
...
void grhayl_superbee_reconstruction(const double U_m2,
                                    const double U_m1,
                                    const double U,
                                    const double U_p1,
                                    double *restrict Ur,
  ...
  sigma_i_1   = grhayl_minmod( (U    - U_m1), 2.0*(U_p1 - U   ) );
  sigma_im1_1 = grhayl_minmod( (U_m1 - U_m2), 2.0*(U    - U_m1) );

  sigma_i_2   = grhayl_minmod( 2.0*(U    - U_m1), (U_p1 - U   ) );
  sigma_im1_2 = grhayl_minmod( 2.0*(U_m1 - U_m2), (U    - U_m1) );
