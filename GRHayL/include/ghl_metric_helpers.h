...
static inline void __attribute__ ((used)) ghl_raise_lower_vector_4D(
      const double g4[][4],
      const double vec[4],
      double vec_inv[4]) {
...
static inline void __attribute__ ((used)) ghl_raise_lower_vector_3D(
...
static inline double __attribute__ ((used)) ghl_compute_vec2_from_vec4D(
      const double g4[][4],
      const double vec[4]) {
...
static inline double __attribute__ ((used)) ghl_compute_vec2_from_vec3D(
      const double gamma[][3],
      const double vec[3]) {
