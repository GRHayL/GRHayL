...
void read_stress_energy_struct_binary(ghl_stress_energy *restrict Tmunu, FILE *restrict outfile);
...
void read_metric_struct_binary(ghl_metric_quantities *restrict metric, FILE *restrict infile);
...
void write_stress_energy_binary(const ghl_stress_energy *restrict Tmunu, FILE *restrict outfile);

void write_metric_binary(const ghl_metric_quantities *restrict metric, FILE *restrict outfile);

// Tabulated EOS helper functions
double get_table_quantity(const int which_var, const double rho, const double Y_e, const double T);
