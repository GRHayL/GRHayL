...
extern bool (*ghl_hybrid_enforce_bounds__rho)(
      const ghl_eos_parameters *restrict eos,
      double *restrict rho);
...
extern ghl_error_codes_t (*ghl_tabulated_compute_P_eps_S_T_from_h)(
      const ghl_eos_parameters *restrict eos,
      const double rho,
      const double Y_e,
      const double h,
...
extern ghl_error_codes_t (*ghl_tabulated_compute_P_eps_dPdrho_dPdeps_T_from_h)(
      const ghl_eos_parameters *restrict eos,
      const double rho,
      const double Y_e,
      const double h,
