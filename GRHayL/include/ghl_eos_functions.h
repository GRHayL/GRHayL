...
extern int (
    *ghl_tabulated_get_index_rho)(const ghl_eos_parameters *restrict eos, const double rho);

extern int (*ghl_tabulated_get_index_T)(const ghl_eos_parameters *restrict eos, const double T);

extern int (*ghl_tabulated_get_index_Ye)(const ghl_eos_parameters *restrict eos, const double Ye);
...
extern double (
    *ghl_tabulated_compute_Ye_from_rho)(const ghl_eos_parameters *restrict eos, const double rho);

extern double (
    *ghl_tabulated_compute_P_from_rho)(const ghl_eos_parameters *restrict eos, const double rho);

extern double (
    *ghl_tabulated_compute_rho_from_P)(const ghl_eos_parameters *restrict eos, const double P);

extern double (
    *ghl_tabulated_compute_eps_from_rho)(const ghl_eos_parameters *restrict eos, const double rho);
