...
int main(int argc, char **argv) {
  ...
  FILE* infile = fopen_with_check("superbee_reconstruction_input.bin", "rb");
  ...
  infile = fopen_with_check("superbee_reconstruction_output.bin","rb");
  ...
  FILE* inpert = fopen_with_check("superbee_reconstruction_output_pert.bin","rb");
