...
int main(int argc, char **argv) {
  ...
  FILE* infile = fopen("enforce_primitive_limits_and_compute_u0.bin","rb");
  check_file_was_successfully_open(infile, "enforce_primitive_limits_and_compute_u0.bin");

  FILE* inpert = fopen("enforce_primitive_limits_and_compute_u0_pert.bin","rb");
  check_file_was_successfully_open(inpert, "enforce_primitive_limits_and_compute_u0_pert.bin");
