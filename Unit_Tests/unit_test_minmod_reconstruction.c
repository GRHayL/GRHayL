...
int main(int argc, char **argv) {
  ...
  for(int k=2; k<dirlength-1; k++)
    ...
    for(int var=0; var<num_vars; var++) {
        ghl_minmod_reconstruction( var_data[var][0], //U_m2
                                        var_data[var][1], //U_m1
                                        var_data[var][2], //U
                                        var_data[var][3], //U_p1
                                        &gfs_r[var],
      ...
      if( validate(rhor_trusted[index], gfs_r[0], rhor_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable rho_r.\n"
        ...
        if( validate(pressr_trusted[index], gfs_r[1], pressr_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable press_r.\n"
        ...
        if( validate(vxr_trusted[index], gfs_r[2], vxr_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vx_r.\n"
        ...
        if( validate(vyr_trusted[index], gfs_r[3], vyr_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vy_r.\n"
        ...
        if( validate(vzr_trusted[index], gfs_r[4], vzr_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vz_r.\n"
        ...
        if( validate(rhol_trusted[index], gfs_l[0], rhol_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable rho_l.\n"
        ...
        if( validate(pressr_trusted[index], gfs_l[1], pressl_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable press_l.\n"
        ...
        if( validate(vxl_trusted[index], gfs_l[2], vxl_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vx_l.\n"
        ...
        if( validate(vyl_trusted[index], gfs_l[3], vyl_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vy_l.\n"
        ...
        if( validate(vzl_trusted[index], gfs_l[4], vzl_pert[index]) )
          ghl_error("Test unit_test_minmod_reconstruction has failed for variable vz_l.\n"
  ...
  ghl_info("minmod reconstruction test has passed!\n");
  free(rho); free(press);
