...
int main(int argc, char **argv) {
  ...
  FILE* infile = fopen("apply_inequality_fixes.bin","rb");
  check_file_was_successfully_open(infile, "apply_inequality_fixes.bin");

  FILE* inpert = fopen("apply_inequality_fixes_pert.bin","rb");
  check_file_was_successfully_open(inpert, "apply_inequality_fixes_pert.bin");
