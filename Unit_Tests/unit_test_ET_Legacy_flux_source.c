...
static inline void compute_h_and_cs2(
      ...
      for(int j = ghostzone; j < dirlength - (ghostzone - 1); j++) {
        for(int i = ghostzone; i < dirlength - (ghostzone - 1); i++) {
          ...
          ghl_initialize_primitives(
              ...
              ONE_OVER_SQRT_4PI * Bz_r[index], poison, poison, poison, // entropy, Y_e, temp
              &prims_r);
          ...
          ghl_initialize_primitives(
              ...
              ONE_OVER_SQRT_4PI * Bz_l[index], poison, poison, poison, // entropy, Y_e, temp
              &prims_l);
    ...
    for(int j = ghostzone; j < dirlength - ghostzone; j++) {
      for(int i = ghostzone; i < dirlength - ghostzone; i++) {
        ...
        ghl_initialize_primitives(
            ...
            ONE_OVER_SQRT_4PI * Bz[index], poison, poison, poison, // entropy, Y_e, temp
            &prims);
