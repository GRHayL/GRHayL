...
int main(int argc, char **argv) {
  ...
  key += fread(gtupyz, sizeof(double), arraylength, infile);
  ...
  infile = fopen_with_check("induction_interpolation_ccc_BSSN_output.bin", "rb");
  ...
  infile = fopen_with_check("induction_interpolation_ccc_BSSN_output_pert.bin", "rb");
  ...
  ghl_info("Interpolation test for cell-centered BSSN inputs has passed!\n");
