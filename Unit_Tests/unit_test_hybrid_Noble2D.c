...
int main(int argc, char **argv) {
  ...
  infile = fopen_with_check("grhayl_con2prim_multi_method_hybrid_Noble2D_output.bin","rb");
  ...
  infile = fopen_with_check("grhayl_con2prim_multi_method_hybrid_Noble2D_output_pert.bin","rb");
