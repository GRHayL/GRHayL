...
static inline void
m1_thcm1_fixture_free_record(m1_thcm1_fixture_record *restrict record) {
  if(record == NULL) {
    return;
  }
  free(record->case_id);
...
static inline void
m1_thcm1_fixture_free(m1_thcm1_fixture_collection *restrict collection) {
  if(collection == NULL) {
    return;
  }
...
static inline int
m1_thcm1_fixture_expect(FILE *restrict file, const char *restrict expected) {
...
static inline int
m1_thcm1_fixture_string(FILE *restrict file, char **restrict destination) {
  char *token = m1_thcm1_fixture_read_token(file);
...
static inline int m1_thcm1_fixture_compare_paired_strict_relative(
      const m1_thcm1_fixture_record *restrict record,
      const double *restrict computed_normalization,
      const double *restrict computed_baseline,
      const double *restrict computed_perturbed,
