...
void ghl_pert_test_fail_stress_energy(
   ...
   * This stress-energy floor matches the momentum fixture portability bound. */
  const double stress_energy_min_rel = 4.0e-13;
  const double stress_energy_min_abs = 1.0e-30;
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[0][0], Tmunu->T4[0][0], Tmunu_pert->T4[0][0], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[0][0]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[0][1], Tmunu->T4[0][1], Tmunu_pert->T4[0][1], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[0][1]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[0][2], Tmunu->T4[0][2], Tmunu_pert->T4[0][2], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[0][2]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[0][3], Tmunu->T4[0][3], Tmunu_pert->T4[0][3], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[0][3]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[1][1], Tmunu->T4[1][1], Tmunu_pert->T4[1][1], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[1][1]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[1][2], Tmunu->T4[1][2], Tmunu_pert->T4[1][2], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[1][2]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[1][3], Tmunu->T4[1][3], Tmunu_pert->T4[1][3], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[1][3]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[2][2], Tmunu->T4[2][2], Tmunu_pert->T4[2][2], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[2][2]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[2][3], Tmunu->T4[2][3], Tmunu_pert->T4[2][3], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[2][3]) > 1.0e-12 ) {
  ...
  if( ghl_pert_test_fail_with_tolerance(Tmunu_trusted->T4[3][3], Tmunu->T4[3][3], Tmunu_pert->T4[3][3], stress_energy_min_rel, stress_energy_min_abs) && fabs(Tmunu->T4[3][3]) > 1.0e-12 ) {
