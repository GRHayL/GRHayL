...
void ghl_pert_test_fail_stress_energy(
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[0][0], Tmunu->T4[0][0], Tmunu_pert->T4[0][0], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[0][1], Tmunu->T4[0][1], Tmunu_pert->T4[0][1], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[0][2], Tmunu->T4[0][2], Tmunu_pert->T4[0][2], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[0][3], Tmunu->T4[0][3], Tmunu_pert->T4[0][3], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[1][1], Tmunu->T4[1][1], Tmunu_pert->T4[1][1], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[1][2], Tmunu->T4[1][2], Tmunu_pert->T4[1][2], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[1][3], Tmunu->T4[1][3], Tmunu_pert->T4[1][3], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[2][2], Tmunu->T4[2][2], Tmunu_pert->T4[2][2], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[2][3], Tmunu->T4[2][3], Tmunu_pert->T4[2][3], 8.0e-14,
           1.0e-12)) {
  ...
  if(ghl_pert_test_fail_with_tolerance(
           Tmunu_trusted->T4[3][3], Tmunu->T4[3][3], Tmunu_pert->T4[3][3], 8.0e-14,
           1.0e-12)) {
