...
int main(int argc, char **argv) {
  ...
  FILE* infile = fopen("mc_reconstruction_input.bin", "rb");
  check_file_was_successfully_open(infile, "mc_reconstruction_input.bin");
  ...
  infile = fopen("mc_reconstruction_output.bin","rb");
  check_file_was_successfully_open(infile, "mc_reconstruction_output.bin");
  ...
  FILE* inpert = fopen("mc_reconstruction_output_pert.bin","rb");
  check_file_was_successfully_open(inpert, "mc_reconstruction_output_pert.bin");
