...
static void check_close(const double actual, const double expected,
                        const char *label, const int case_index) {
...
static void check_number_product_overflow(const ghl_m1_parameters *params) {
  ...
  const ghl_m1_closure closure = {.chi = 1.0/3.0,
  ...
  for(int side = 0; side < 2; ++side) {
    ...
    if(ghl_m1_compute_neutrino_rusanov_flux(params, &nu, &metric,
        ghl_m1_dirn0, &state[0], &state[1], &closure, &closure,
        number[0], number[1], velocity[0], velocity[1], 1.0, &N, &E, F)
        != ghl_error_m1_invalid_state || N != -1.0 || E != -2.0 ||
        F[0] != -3.0 || F[1] != -4.0 || F[2] != -5.0)
...
static void check_neutrino_number_transport_boundaries(
  ...
  const ghl_m1_neutrino_state state = {
  ...
  ghl_m1_neutrino_current current = {
      .J = 91.0, .h_n = 92.0, .HU = {93.0, 94.0, 95.0},
      .Gamma_N = 96.0, .n_com = 97.0,
  ...
  zero_nu.N_floor = 0.0;
  const ghl_error_codes_t zero_gamma_error =
      ghl_m1_neutrino_build_current_from_moments(
         metric, &zero_nu, &bad_state, &bad_comoving, V_con, 1.0,
         &current);
  if(zero_gamma_error != ghl_success)
    fail_case("zero-N singular Gamma_N returned an error", 317);
  if(current.n_com != 0.0 ||
     current.number_flux[0] != 0.0 || current.number_flux[1] != 0.0 ||
     current.number_flux[2] != 0.0 ||
  ...
  if(ghl_m1_neutrino_build_current_from_moments(
         metric, nu_params, &state, &bad_comoving, huge_V, DBL_MAX,
         &current) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_neutrino_build_current_from_moments(
         metric, nu_params, &bad_state, &bad_comoving, large_V, 3.0,
         &current) != ghl_error_m1_invalid_state)
    fail_case("nonfinite number flux was accepted", 319);
  if(ghl_m1_neutrino_build_current_from_moments(
         metric, nu_params, &state, &bad_comoving, large_V, 3.0,
         &current) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_closure(
         m1_params, metric, prims, &state, &closure) != ghl_success)
  ...
  if(ghl_m1_compute_neutrino_number_flux(
         ...
         number_velocity) != ghl_error_m1_null_pointer ||
  ...
  bad_state.F[0] = 2.0;
  if(ghl_m1_compute_neutrino_number_flux(
         m1_params, nu_params, metric, prims, &bad_state, number_flux,
         number_velocity) != ghl_error_m1_invalid_state ||
     memcmp(number_flux, number_flux_before, sizeof(number_flux)) != 0 ||
     memcmp(number_velocity, number_velocity_before,
            sizeof(number_velocity)) != 0)
    fail_case("number-flux invalid state was not transactional", 323);

  if(ghl_m1_neutrino_derive_current(
         NULL, nu_params, metric, prims, &state, &current) !=
         ghl_error_m1_null_pointer ||
     ghl_m1_neutrino_derive_current(
         m1_params, NULL, metric, prims, &state, &current) !=
         ghl_error_m1_null_pointer ||
     ghl_m1_neutrino_derive_current(
  ...
  bad_nu.N_floor = NAN;
  if(ghl_m1_neutrino_derive_current(
         m1_params, &bad_nu, metric, prims, &state, &current) !=
         ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_neutrino_derive_current_from_closure(
     ...
     ghl_m1_neutrino_derive_current_from_closure(
         ...
         ghl_error_m1_null_pointer ||
     ghl_m1_neutrino_derive_current_from_closure(
         m1_params, nu_params, metric, prims, &state, &bad_closure,
         &current) != ghl_error_m1_invalid_state)
    fail_case("closure-supplied current boundary failed", 334);

  current = (ghl_m1_neutrino_current){
      .number_flux = {0.25, -0.1, 0.05},
  ...
  if(ghl_m1_neutrino_physical_number_flux_from_current(
         metric, &state, &current, (ghl_m1_direction_t)3,
         &physical_number) != ghl_error_m1_invalid_state)
    fail_case("invalid physical number direction was accepted", 336);
  if(ghl_m1_neutrino_physical_number_flux_from_current(
         &bad_metric, &state, &current, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_invalid_metric)
    fail_case("invalid physical number metric was accepted", 337);
  bad_state = state;
  bad_state.N = NAN;
  if(ghl_m1_neutrino_physical_number_flux_from_current(
         metric, &bad_state, &current, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_neutrino_physical_number_flux_from_current(
         metric, &state, &bad_current, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_neutrino_physical_number_flux_from_current(
         &huge_lapse_metric, &state, &current, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, NULL,
         public_number_flux, number_velocity) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, &closure,
         NULL, number_velocity) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, &closure,
         public_number_flux, NULL) != ghl_error_m1_null_pointer)
    fail_case("closure number-flux output NULL boundary failed", 343);
  if(ghl_m1_compute_neutrino_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, &bad_closure,
         public_number_flux, number_velocity) != ghl_error_m1_invalid_state ||
     memcmp(public_number_flux, public_number_flux_before,
            sizeof(public_number_flux)) != 0)
    fail_case("closure number-flux invalid input was not transactional", 344);

  if(ghl_m1_compute_neutrino_physical_number_flux(
         NULL, nu_params, metric, prims, &state, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_physical_number_flux(
         m1_params, nu_params, NULL, prims, &state, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_physical_number_flux(
         m1_params, nu_params, metric, prims, NULL, ghl_m1_dirn0,
         &physical_number) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_physical_number_flux(
         m1_params, nu_params, metric, prims, &state, ghl_m1_dirn0,
  ...
  if(ghl_m1_compute_neutrino_physical_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, NULL,
         ghl_m1_dirn0, &physical_number) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_physical_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, &closure,
         ghl_m1_dirn0, NULL) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_physical_number_flux_from_closure(
         m1_params, nu_params, metric, prims, &state, &bad_closure,
         ghl_m1_dirn0, &physical_number) != ghl_error_m1_invalid_state)
...
static void check_neutrino_rusanov_boundaries(
      ...
      const ghl_metric_quantities *restrict metric,
      const ghl_primitive_quantities *restrict prims) {
  const ghl_m1_neutrino_state state_L = {
      .N = 1.0, .E = 1.0, .F = {0.0, 0.0, 0.0}};
  const ghl_m1_neutrino_state state_R = {
      .N = 1.5, .E = 1.2, .F = {0.0, 0.0, 0.0}};
  ghl_m1_closure closure_L = {0};
  ghl_m1_closure closure_R = {0};
  if(ghl_m1_compute_neutrino_closure(
         m1_params, metric, prims, &state_L, &closure_L) != ghl_success ||
     ghl_m1_compute_neutrino_closure(
         m1_params, metric, prims, &state_R, &closure_R) != ghl_success)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         NULL, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, NULL, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, NULL, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, NULL, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, NULL,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         NULL, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, NULL, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, NULL, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, NULL,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         NULL, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, NULL, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, NULL, &flux_E,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, NULL,
         flux_F) != ghl_error_m1_null_pointer ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, (ghl_m1_direction_t)3, &state_L,
         &state_R, &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, NAN, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state ||
     ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, -1.0, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
    fail_case("neutrino Rusanov direction/speed validation failed", 352);
  ghl_metric_quantities bad_metric = *metric;
  bad_metric.gammaDD[0][0] = -1.0;
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &bad_metric, ghl_m1_dirn0, &state_L,
         &state_R, &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_metric)
    fail_case("neutrino Rusanov invalid metric was accepted", 353);
  ghl_m1_neutrino_parameters bad_nu = *nu_params;
  bad_nu.N_floor = NAN;
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, &bad_nu, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  bad_state.F[0] = 2.0;
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &bad_state,
         &state_R, &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  bad_state.F[0] = 2.0;
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L,
         &bad_state, &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &bad_closure, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &bad_closure, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, bad_number_flux, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, bad_number_flux,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R, bad_velocity,
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, number_flux_L, number_flux_R,
         number_velocity_L, bad_velocity, 0.5, &flux_N, &flux_E, flux_F) !=
         ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &state_R,
         &closure_L, &closure_R, inconsistent_flux, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state || flux_N != output_before[0] ||
     flux_E != output_before[1] || memcmp(flux_F, output_before + 2,
                                          sizeof(flux_F)) != 0)
  ...
  zero_nu.N_floor = 0.0;
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, &zero_nu, metric, ghl_m1_dirn0, &zero_state,
         &zero_state, &closure_L, &closure_L, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_success)
    fail_case("zero-N zero-current Rusanov case failed", 376);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, &zero_nu, metric, ghl_m1_dirn0, &zero_state,
         &state_R, &closure_L, &closure_R, inconsistent_flux, number_flux_R,
         number_velocity_L, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &huge_lapse_metric, ghl_m1_dirn0,
         &huge_number_state, &state_R, &closure_L, &closure_R,
         huge_number_flux, number_flux_R,
         unit_number_velocity, number_velocity_R, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
    fail_case("left physical number overflow was accepted", 378);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &huge_lapse_metric, ghl_m1_dirn0,
         &state_R, &huge_number_state, &closure_R, &closure_L,
         number_flux_R, huge_number_flux, number_velocity_R,
         unit_number_velocity, 0.5, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_closure(
         m1_params, metric, prims, &high_state, &high_closure) != ghl_success)
    fail_case("high-energy neutrino closure construction failed", 380);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &huge_lapse_metric, ghl_m1_dirn0,
         &high_state, &state_R, &high_closure, &closure_R, number_flux_L,
         number_flux_R, number_velocity_L, number_velocity_R, 0.5, &flux_N,
         &flux_E, flux_F) != ghl_error_m1_invalid_state)
    fail_case("left physical E/F overflow was accepted", 381);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &huge_lapse_metric, ghl_m1_dirn0, &state_L,
         &high_state, &closure_L, &high_closure, number_flux_L,
         number_flux_R, number_velocity_L, number_velocity_R, 0.5, &flux_N,
         &flux_E, flux_F) != ghl_error_m1_invalid_state)
    fail_case("right physical E/F overflow was accepted", 382);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, metric, ghl_m1_dirn0, &state_L, &high_state,
         &closure_L, &high_closure, number_flux_L, number_flux_R,
         number_velocity_L, number_velocity_R, DBL_MAX, &flux_N, &flux_E,
         flux_F) != ghl_error_m1_invalid_state)
  ...
  if(ghl_m1_compute_neutrino_closure(
         m1_params, &large_metric, prims, &large_state,
         &large_closure) != ghl_success)
    fail_case("large-metric closure construction failed", 384);
  if(ghl_m1_compute_neutrino_rusanov_flux(
         m1_params, nu_params, &large_metric, ghl_m1_dirn0, &large_state,
         &large_state, &large_closure, &large_closure, number_flux_L,
         number_flux_R, number_velocity_L, number_velocity_R, 0.0, &flux_N,
         &flux_E, flux_F) != ghl_error_m1_invalid_state)
...
int main(int argc, char **argv) {
  ...
  if(ghl_m1_initialize(
         ...
         20, 1.0e-10, &m1_params) != ghl_success)
  ...
  if(ghl_m1_compute_neutrino_closure(&m1_params, NULL, NULL, no_state,
        &rejected_closure) != ghl_error_m1_null_pointer || rejected_closure.xi != -1.0)
    fail_case("NULL neutrino closure state changed output", -1);
  char fixture_error[256] = {0};
  if(!m1_thcm1_rusanov_check_neutrino_fixture(
         fixture_dir, &m1_params, &nu_params,
         fixture_error, sizeof(fixture_error)))
    fail_case(fixture_error[0] != '\0' ? fixture_error :
              "neutrino Rusanov fixture evaluation failed", -2);
  memset(fixture_error, 0, sizeof(fixture_error));
  if(!m1_thcm1_rusanov_check_current_fixture(
         fixture_dir, &m1_params, &nu_params,
         fixture_error, sizeof(fixture_error)))
    fail_case(fixture_error[0] != '\0' ? fixture_error :
              "current neutrino Rusanov fixture evaluation failed", -3);
  else
  ...
  for(int case_index = 0; case_index < M1_NEUTRINO_SEEDED_CASE_COUNT;
      ++case_index) {
    ...
    if(ghl_m1_compute_neutrino_closure(
           ...
           &test_case.state, &closure_L) != ghl_success ||
       ghl_m1_compute_neutrino_closure(
           &m1_params, &test_case.metric, &test_case.prims,
           &test_case.perturbed_state, &closure_R) != ghl_success)
    ...
    if(ghl_m1_compute_neutrino_number_flux_from_closure(
       ...
       ghl_m1_compute_neutrino_number_flux_from_closure(
           &m1_params, &nu_params, &test_case.metric, &test_case.prims,
           &test_case.perturbed_state, &closure_R, number_flux_R,
           number_velocity_R) != ghl_success)
    ...
    if(ghl_m1_compute_physical_flux(
           &test_case.metric, direction, &rad_L, &closure_L,
           &physical_E_L, physical_F_L) != ghl_success ||
       ghl_m1_compute_physical_flux(
           &test_case.metric, direction, &rad_R, &closure_R,
           &physical_E_R, physical_F_R) != ghl_success)
    ...
    const double physical_N_R = test_case.metric.lapse * number_flux_R[d]
                              - test_case.metric.betaU[d] *
    ...
    if(ghl_m1_compute_neutrino_rusanov_flux(
           ...
           &test_case.state, &test_case.perturbed_state, &closure_L,
           &closure_R, number_flux_L, number_flux_R, number_velocity_L,
           number_velocity_R, speed, &actual_N, &actual_E, actual_F) !=
           ghl_success)
    ...
    const double physical_L[5] = {
        physical_N_L, physical_E_L, physical_F_L[0], physical_F_L[1],
        physical_F_L[2]};
    const double physical_R[5] = {
        physical_N_R, physical_E_R, physical_F_R[0], physical_F_R[1],
        physical_F_R[2]};
    const double actual[5] = {actual_N, actual_E,
                              actual_F[0], actual_F[1], actual_F[2]};
    for(int component = 0; component < 5; ++component) {
      ...
      check_close(actual[component], expected,
                  "combined Rusanov component mismatch", case_index);
    }
    ...
    if(ghl_m1_compute_neutrino_rusanov_flux(
           ...
           &test_case.state, &test_case.perturbed_state, &closure_L,
           &closure_R, number_flux_L, number_flux_R, number_velocity_L,
           number_velocity_R, -1.0, &rejected_N, &rejected_E, rejected_F) !=
           ghl_error_m1_invalid_state || rejected_N != 71.0 ||
       rejected_E != 72.0 || rejected_F[0] != 73.0 ||
  ...
  ghl_info("unit_test_m1_neutrino_rusanov_flux: %d seeded paired cases passed\n",
