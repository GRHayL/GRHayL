...
void ghl_pert_test_fail_conservatives(
   ...
   * This momentum-specific floor remains tight while avoiding fixture failures. */
  const double momentum_min_rel = 4.0e-13;
  const double momentum_min_abs = 1.0e-30;
  ...
  if( ghl_pert_test_fail_with_tolerance(
        ...
        momentum_min_rel, momentum_min_abs) ) {
