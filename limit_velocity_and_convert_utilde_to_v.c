...
void limit_velocity_and_convert_utilde_to_v( const eos_parameters *restrict eos,
  ...
  double u0L = (au0m1+1.0)*metric->lapseinv;
...
CCTK_VINFO("                 to [%e,%e,%e]",utcon1,utcon2,utcon3);
  ...
  *utcon3_ptr = utcon3;
  ...
  prims->vx = utcon1/u0L - metric->betax;
  prims->vy = utcon2/u0L - metric->betay;
  prims->vz = utcon3/u0L - metric->betaz;
