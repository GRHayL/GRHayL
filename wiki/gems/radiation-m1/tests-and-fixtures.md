...
the provider test. On a clean checkout it expands the tracked fixture archive
before auditing the payloads. It does not regenerate the retained reference data.
...
- [`payloads.tar.gz`](../../../Unit_Tests/data/m1_thcm1/payloads.tar.gz)
  contains the retained payloads for clean checkouts; expanded `.m1` and `.dat`
