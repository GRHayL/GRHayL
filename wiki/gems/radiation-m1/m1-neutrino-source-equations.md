...
bounds and diagnostics, without repeating the number update. Charged-current
lepton exchange instead uses the un-repaired physical number endpoint selected
