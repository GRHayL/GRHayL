...
energy floor and, when needed, the flux magnitude. It records the original
and permitted norms, applied scale, repaired state, and whether the energy
floor and/or flux rescale branch ran.
