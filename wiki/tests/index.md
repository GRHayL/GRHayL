...
| [Unit-test coverage and gap matrix](unit-test-coverage-and-gap-matrix.md) | Behavior-family coverage, weak spots, test-only helper boundaries, and review impact paths. |
