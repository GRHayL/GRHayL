...
void GRHayL_IGM_phitilde_and_A_gauge_rhs(
      ...
      double *restrict lapse_interp,
      double *restrict lapse_Phi_minus_betaj_A_j_interp,
      double *restrict lapse_sqrtg_Ax_interp,
      double *restrict lapse_sqrtg_Ay_interp,
      double *restrict lapse_sqrtg_Az_interp,
