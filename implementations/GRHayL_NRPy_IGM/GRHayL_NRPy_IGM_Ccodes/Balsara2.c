...
/*
 * Generate Balsara2 1D initial data
 */
    ...
    for (int i1 = 0; i1 < Nxx_plus_2NGHOSTS1; i1++) {
      ...
      for (int i0 = 0; i0 < Nxx_plus_2NGHOSTS0; i0++) {
        const REAL xx0 = xx[0][i0];
        {
          ...
          evol_gfs[IDX4S(AD0GF, i0, i1, i2)] = (6*FDPart3_1 + (7.0/10.0)*FDPart3_4)*(0.5*dxx2 + xx2);
          evol_gfs[IDX4S(AD1GF, i0, i1, i2)] = FDPart3_6*(6*(FDPart3_0 + FDPart3_7 - 1.0/2.0*fabs(FDPart3_6))/(FDPart3_6 - TINYDOUBLE) + (7.0/10.0)*(FDPart3_3 + FDPart3_7 + (1.0/2.0)*fabs(FDPart3_2 + FDPart3_5))/(FDPart3_2 + FDPart3_5));
          ...
          auxevol_gfs[IDX4S(PGF, i0, i1, i2)] = 30*FDPart3_1 + FDPart3_4;
